(function () 
{
    ...
    SceneJS.Types.addType("Wall/OneWindow", { construct:function (params) { this.addNode(build.call(this, params)); }});

    function build(params) 
	{
        var x, y, z, center, windowC, windowW, windowH;
		...
		if(params.windowc && params.windows && params.windoww) 
		{ windowC = params.windowc; windowH = params.windowH; windowW = params.windoww;}
		
        var coreId = "Wall/OneWindow" + x + "_" + y + "_" + z + (params.wire ? "wire" : "_solid");
